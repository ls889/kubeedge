...
func (e *edged) Start() {
	...
	go e.pluginManager.Run(edgedutil.NewEmptySourcesReady(), utilwait.NeverStop)
...
func (e *edged) initializeModules() error {
	...
	err = e.containerManager.Start(node, e.GetActivePods, edgedutil.NewEmptySourcesReady(), e.statusManager, e.runtimeService)
	if err != nil {
...
func (e *edged) syncPod() {
	...
	//when starte, send msg to metamanager to get existing pods
